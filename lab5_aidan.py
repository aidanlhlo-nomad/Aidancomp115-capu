...
def convert_american_dollars(american_dollars):
    exchange_rate = 1.34
    converted_amount=(american_dollars * exchange_rate)
    return round(converted_amount,2)#Round to the result to two decimal place
...
def back_day_from_trip(day_today, days_trip):
    days_number=(day_today + days_trip)%7
    return days_week[days_number]
