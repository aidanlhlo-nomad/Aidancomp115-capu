...
assert reverse_str('capilano') == 'onalipac'
assert reverse_str('snickers') == 'srekcins'
...
print(count_vowels('tree'))

# Your unit test
assert count_vowels ('tree') == 2
assert count_vowels ('aidan')== 3 
...
print(remove_duplicates('dogg'))

# Your unit tests
assert remove_duplicates('dogg')== 'dog'
assert remove_duplicates('uranus')== 'urans'
...
def project_completion_day(day, days_to_completion):
    ...
    Write your docstring
    """
    day = int(days_week.index(day))
    day_of_return_index = (day+days_to_completion)%7
    day_of_return = days_week[day_of_return_index]
